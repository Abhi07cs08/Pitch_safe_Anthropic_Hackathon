...
app.get('/api/ml/get-all-predictions', (req, res) => mlController.getAllPredictions(req, res)); // for claude

// Claude route
app.post('/api/claude/coach-analysis', (req, res) => claudeController.generateCoachAnalysis(req, res));
...
app.listen(PORT, () => {
  ...
  console.log('  POST /api/claude/coach-analysis');
  console.log('  GET  /api/ml/get-all-predictions');
});